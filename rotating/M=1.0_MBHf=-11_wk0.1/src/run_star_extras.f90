...
! ***********************************************************************
      ...
      integer function extras_finish_step(id)
         ...
         s% xtra(14) = s% L(1)  ! L_star  
         ! s% xtra(2) ! L_BH
         
         s% profile_data_suffix = '.data'
         
         if (s%xtra(2) / s%xtra(14) >= 0.001 .and. s%xtra(2) / s%xtra(14) < 0.01 .and. .not. s%lxtra(16)) then
             ! L_BH = 1/1000 L_star
             ...
             s%lxtra(16) = .true.
         else if (s%xtra(2) / s%xtra(14) >= 0.01 .and. s%xtra(2) / s%xtra(14) < 0.1 .and. .not. s%lxtra(17)) then
             ! L_BH = 1/100 L_star
             ...
             s%lxtra(17) = .true.
         else if (s%xtra(2) / s%xtra(14) >= 0.1 .and. s%xtra(2) / s%xtra(14) < 1 .and. .not. s%lxtra(18)) then
             ! L_BH = 1/10 L_star
             ...
             s%lxtra(18) = .true.
         else if (s%xtra(2) / s%xtra(14) >= 1 .and. s%xtra(2) / s%xtra(14) < 10 .and. .not. s%lxtra(19)) then
             ! L_BH = L_star
             ...
             s%lxtra(19) = .true.
         else if (s%xtra(2) / s%xtra(14) >= 10 .and. s%xtra(2) / s%xtra(14) < 100 .and. .not. s%lxtra(20)) then
             ! L_BH = 10 L_star
             ...
             s%lxtra(20) = .true.
         else if (s%xtra(2) / s%xtra(14) >= 100 .and. s%xtra(2) / s%xtra(14) < 1000 .and. .not. s%lxtra(21)) then
             ! L_BH = 100 L_star
         ...
         !write(*,*) s% xtra(1)/Msun, 'MBH'

         if ( s% xtra(1)/Msun >= 0.00001 .and. .not. s%lxtra(23)) then
            ! L_BH = 1/1000 L_star
            s% profile_data_suffix = '_mbh_1d-5.data'
            s%need_to_save_profiles_now = .true.
            s%need_to_update_history_now = .true.
            write(*,*) 'Save profile at M_BH = 1d-5 Msun'
            s%lxtra(23) = .true.
        else if ( s% xtra(1)/Msun >= 0.0001 .and. .not. s%lxtra(24)) then
            ! L_BH = 1/1000 L_star
            s% profile_data_suffix = '_mbh_1d-4.data'
            s%need_to_save_profiles_now = .true.
            s%need_to_update_history_now = .true.
            write(*,*) 'Save profile at M_BH = 1d-4 Msun'
            s%lxtra(24) = .true.
         else if ( s% xtra(1)/Msun >= 0.001 .and. .not. s%lxtra(25)) then
            ! L_BH = 1/1000 L_star
            s% profile_data_suffix = '_mbh_1d-3.data'
            s%need_to_save_profiles_now = .true.
            s%need_to_update_history_now = .true.
            write(*,*) 'Save profile at M_BH = 1d-3 Msun'
            s%lxtra(25) = .true.
        endif
